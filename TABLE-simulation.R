...
##  4:         coverage          94.56%          95.45%          94.55%          95.58%          95.08%
...
##  9: median bias LMME  -3.30% / 4.19%  -3.30% / 4.19%  -3.28% / 4.19%  -3.43% / 4.19%  -3.48% / 4.05%
## 10:  median bias MUE -0.36% / -0.89% -9.45% / -4.17% -0.35% / -0.89% -9.36% / -4.27% -3.44% / -1.92%
...
##  4:         coverage         95.61%          97.05%         95.61%          97.10%          96.37%
...
##  9: median bias LMME -0.38% / 5.72%  -0.42% / 5.96% -0.38% / 5.74%  -0.43% / 5.83%  -0.47% / 5.99%
## 10:  median bias MUE -0.38% / 0.44% -0.42% / -2.67% -0.38% / 0.45% -0.43% / -3.05% -0.33% / -0.25%
...
##  3:       CI [NA,NA]               0               0               0               0               0
##  4:         coverage          94.82%          95.54%          94.78%          95.53%          95.25%
##  5:         reversal     0.75%/0.15%     0.47%/0.46%     0.88%/0.16%     0.44%/0.46%         0/0.85%
##  6:         abnormal         0.59%/0             0/0         0.56%/0             0/0         0/0.31%
##  7:   mean bias LMME  -0.019 / 0.017  -0.019 / 0.017  -0.018 / 0.017  -0.020 / 0.018  -0.020 / 0.017
##  8:    mean bias MUE  -0.003 / 0.004 -0.057 / -0.030  -0.003 / 0.004 -0.059 / -0.031 -0.028 / -0.017
##  9: median bias LMME  -1.39% / 2.16%  -1.39% / 2.16%  -1.32% / 2.15%  -1.52% / 2.19%  -1.64% / 1.97%
## 10:  median bias MUE -0.47% / -1.02% -7.49% / -3.50% -0.49% / -1.01% -7.35% / -3.56% -3.71% / -2.15%
...
##  4:         coverage         95.90%          96.92%         95.97%          96.93%          96.66%
...
##  9: median bias LMME -0.46% / 3.13%  -0.52% / 3.37% -0.47% / 3.25%  -0.53% / 3.29%  -0.62% / 3.24%
## 10:  median bias MUE -0.46% / 0.30% -0.52% / -2.15% -0.47% / 0.44% -0.53% / -2.28% -0.22% / -0.92%
...
##  4:         coverage         94.71%          95.82%         94.73%          95.88%          94.98%
##  5:         reversal    0.32%/0.11%     0.16%/0.46%    0.32%/0.12%     0.14%/0.46%         0/0.98%
##  6:         abnormal        0.52%/0             0/0        0.50%/0             0/0         0/0.08%
##  7:   mean bias LMME -0.070 / 0.052  -0.070 / 0.052 -0.069 / 0.052  -0.070 / 0.053  -0.070 / 0.053
##  8:    mean bias MUE -0.037 / 0.026 -0.135 / -0.025 -0.036 / 0.026 -0.137 / -0.025  -0.068 / 0.004
##  9: median bias LMME -5.04% / 5.42%  -5.04% / 5.43% -5.02% / 5.42%  -5.15% / 5.46%  -5.18% / 5.31%
## 10:  median bias MUE 0.35% / -0.44% -5.08% / -4.72% 0.36% / -0.44% -5.24% / -4.90% -1.89% / -2.63%
...
##  3:       CI [NA,NA]          4.29%           4.93%          4.37%           4.66%          5.13%
##  4:         coverage         96.10%          97.93%         96.12%          97.94%         96.99%
...
##  8:    mean bias MUE  0.003 / 0.065   0.002 / 0.020  0.003 / 0.065   0.002 / 0.017  0.003 / 0.049
##  9: median bias LMME -0.12% / 7.72%  -0.16% / 8.11% -0.12% / 7.76%  -0.17% / 7.91% -0.22% / 8.22%
## 10:  median bias MUE -0.14% / 2.15% -0.19% / -1.93% -0.13% / 2.18% -0.17% / -2.42% -0.10% / 0.17%
...
##  3:       CI [NA,NA]              0               0              0               0               0
##  4:         coverage         94.66%          95.56%         94.66%          95.66%          95.23%
##  5:         reversal    0.84%/0.26%     0.60%/0.71%    1.06%/0.29%     0.57%/0.72%         0/1.12%
##  6:         abnormal        0.69%/0             0/0        0.67%/0             0/0         0/0.33%
##  7:   mean bias LMME -0.042 / 0.030  -0.042 / 0.030 -0.042 / 0.029  -0.043 / 0.030  -0.043 / 0.031
##  8:    mean bias MUE -0.021 / 0.016 -0.086 / -0.020 -0.020 / 0.016 -0.089 / -0.021 -0.051 / -0.006
##  9: median bias LMME -3.53% / 2.74%  -3.53% / 2.75% -3.50% / 2.73%  -3.62% / 2.78%  -3.69% / 2.87%
## 10:  median bias MUE 0.31% / -0.36% -3.42% / -3.04% 0.34% / -0.37% -3.67% / -3.12% -1.91% / -2.59%
...
##  4:         coverage         96.43%          97.85%         96.53%          97.89%         97.28%
##  5:         reversal    0.88%/0.26%     0.60%/0.71%    1.06%/0.29%     0.65%/0.71%        0/1.13%
##  6:         abnormal        0.73%/0             0/0        0.71%/0             0/0        0/0.40%
##  7:   mean bias LMME  0.000 / 0.059  -0.000 / 0.062  0.000 / 0.060  -0.000 / 0.061 -0.001 / 0.062
##  8:    mean bias MUE  0.000 / 0.047  -0.001 / 0.018 -0.000 / 0.049  -0.001 / 0.015  0.003 / 0.032
##  9: median bias LMME -0.10% / 5.07%  -0.15% / 5.50% -0.10% / 5.20%  -0.14% / 5.37% -0.26% / 5.43%
## 10:  median bias MUE -0.13% / 2.00% -0.18% / -0.11% -0.12% / 2.15% -0.17% / -0.28%  0.08% / 0.01%
